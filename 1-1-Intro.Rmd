...
\begin{textblock}{5.5}(6.8,0)\begin{alertblock}{}\Large robjhyndman.com\end{alertblock}\end{textblock}
...
\begin{tabular}{rp{6.6cm}l}
  ...
  1.4     & Seasonality and trends        & 6 \\
  1.5     & Exponential smoothing         & 7 \\
  \midrule
